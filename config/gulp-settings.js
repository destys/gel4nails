...
export const path = {
	...
	ftp: `/wordpress_i1ww3/public_html/wp-content/themes/gell4nails/build`
...
export const configFTP = {
	host: "188.225.40.140", // Адреса FTP сервера
	user: "cz20207_somedev", // Ім'я користувача
	password: "mordor011", // Пароль
