...
export class FullPage {
	...
	//===============================
	// Удаление классов с различными эффектами
	...
	//===============================
	// Функция проверки был ли элемент полностью прокручен
	checkScroll(yCoord, element) {
		this.goScroll = false;

		// Есть ли элемент и готов ли он к работе
	...
	touchDown(e) {
		...
		if (this._eventElement) {
			// Повесить событие touchmove и touchup
