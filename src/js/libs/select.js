...
class SelectConstructor {
	constructor(props, data = null) {
		...
		// CSS классы модуля
		this.selectClasses = {
			classSelect: "select", // Главнвй блок
			classSelectBody: "select__body", // Тело селекта
			classSelectTitle: "select__title", // Заголовок
			classSelectValue: "select__value", // Значение в заголовку
			classSelectLabel: "select__label", // Лэйбл
			classSelectInput: "select__input", // Поле ввода
			classSelectText: "select__text", // Оболочка текстових данных
			classSelectLink: "select__link", // Ссылка в елементе
			classSelectOptions: "select__options", // Раскрывающийся список
			...
			classSelectDisabled: "_select-disabled", // выключено
			classSelectTag: "_select-tag", // Класс тега
			classSelectOpen: "_select-open", // Список открытый
			classSelectActive: "_select-active", // Список вибран
			...
			classSelectOptionSelected: "_select-selected", // Вибранный пункт
		...
		if (this.config.init) {
			...
			if (selectItems.length) {
				...
				this.setLogging('Сплю, нет select');
			}
		}
	}
	...
	selectBuild(originalSelect) {
		...
		// Установка флажка для элементов под (только для нескольких)
	...
	setSelectChange(originalSelect) {
		...
		// При изменении селекта присылаем форму
	...
	// Обработчик поиска по елементам списка
